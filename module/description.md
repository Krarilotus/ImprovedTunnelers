...
Terrain and walkability are restored when a tunnel finishes, before delayed damage. Map terrain therefore does not depend on a saved tunneler queue. Without the module, its pending damage and building restrictions are not continued. Native editor testing is still pending.
